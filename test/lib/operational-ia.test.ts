...
describe('one-purpose control app information architecture', () => {
	...
	it('uses project-first host setup and operational host inventory', () => {
		...
		expect(projectCreate).toContain("'starter-research'");
		expect(projectCreate).toContain("'starter-engineering'");
		expect(projectCreate).toContain("'starter-information-hub'");
		...
		expect(projectCreate).toContain("sourceRef: value(formData, 'sourceRef') || pageData.defaultTemplateId || 'starter-research'");
