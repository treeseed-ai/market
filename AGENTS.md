...
- Use `npx trsd stage --verify none --ci off --cleanup manual --json "message"` only when intentionally handing an unverified staging merge to the staging release agent.
