...
- `@treeseed/api` owns authorization, TreeDX workspace/review/publication admission, workflow metadata, capacity assignment coordination, and policy-filtered knowledge APIs. Markdown remains in Git and TreeDX rather than PostgreSQL.
